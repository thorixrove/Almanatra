...
import { CallControls, StreamVideo, StreamCall, StreamTheme, SpeakerLayout } from "@stream-io/video-react-sdk"
...
function OrderVideoPage() {
    ...
    if (loadError || !order ) {
        return (
            <PageError message="Order not found or you don't have access."
            action={{ to: "/order", label: "Back to orders"}}
            />
        )
    }
  ...
  return (
    <div className="space-y-4 text-left">
        <Link to={`/order/${id}/chat`} className="btn btn-ghost btn-sm gap-2 text-base-content/80">
        ...
        <div className="flex min-h-130 flex-col overflow-hidden rounded-box border border-base-300
        bg-base-100">
                ...
                <StreamCall call={call}>
                    <StreamTheme className="str-video__theme-custom">
                        <div className="flex min-h-0 flex-col">
                            ...
                            <div className="shrink border-t border-base-300 bg-base-200/90 px-2 py-3 [&_.str-video__call-controls]:flex-wrap
                            [&_.str-video__call-controls]:justify-center">
