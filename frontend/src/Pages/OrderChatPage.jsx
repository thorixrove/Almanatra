...
function OrderChatPage() {
  ...
  if (!paid) {
    return <p className="tect-base-content/60">Complete payment to open support chat.</p>
  }
      ...
      <div className="card border border-base-300 bg-base-100 shadow-sm">
        <div className="card-body flex-row flex-wrap items-start gap-4">
          ...
          <div className="flex-1">
            ...
            Ask about this order, shipping, or returns. Support can send video call link here 
