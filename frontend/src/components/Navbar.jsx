    ...
    backdrop-blur-md'>
      <div className='navbar mx-auto min-h-14 max-w-7xl px-4 py-2.5 md:px-6 md:py-3'>
        <div className='flex-1'>
          <Link to="/" className='btn btn-ghost gap-2 px-2 font-mono text-lg font-semibold uppercase tracking-wide
          md:text-xl'>
            ...
            <span className='leading none'>Almanatra</span>
          </Link>
        </div>
